...
%
% Author: zplotzke
% Last Modified: 2025-02-11 15:08:52 UTC
% Version: 1.0.0
...
config.visualization = struct(...
    'window_size', [1280, 720], ...         % Visualization window size [width, height]
    'truck_colors', {{'b', 'r', 'g', 'y'}}, ... % Colors for each truck
    'plot_refresh_rate', 5, ...             % Plot refresh rate (Hz)
    'show_predictions', true, ...           % Show LSTM predictions
    'show_safety_zones', true, ...          % Show safety zones around trucks
    'plot_history_length', 1000 ...         % Number of points in history plots
    );
